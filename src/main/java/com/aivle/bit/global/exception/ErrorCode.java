...
public enum ErrorCode {
    ...
    NO_SEARCH_COMPANY_FINANCIAL_SUMMARY(BAD_REQUEST, "회사 재무제표를 찾을 수 없습니다."),
    NO_SEARCH_COMPANY_ANALYSIS(BAD_REQUEST, "회사 분석 정보를 찾을 수 없습니다."),
    ...
    NOT_CSV_FILE(BAD_REQUEST, "csv 파일이 아닙니다."),
    OVER_MAX_FILE_SIZE(BAD_REQUEST, "파일 크기가 5MB를 초과했습니다."),
    INVALID_CSV_COLUMN(BAD_REQUEST, "csv 파일의 컬럼이 올바르지 않습니다."),
